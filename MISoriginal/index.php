        ...
        <div class="vote_container"> 
        	<form id="vote" name="vote" method="post"  action="vote.php">
            	<div class="header_vote"> 
                	<div id="header_vote_title">Genre Votes</div>
...
<div class="col1"><!--Start Bottom web content-->
	...
	<div class="col2">
    	<div class="header">
    		<div id="header_title">JINGLES TOP 10 SONGS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Frontend/SongRank.php" id="link" style="font:Verdana, Geneva, sans-serif; font-size:12px;">See Rankings</a></div>
